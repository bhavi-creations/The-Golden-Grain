    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-flex justify-content-center align-items-center bg-light">
                        <img src="./img/preload.png" alt="Register Image" class="img-fluid" style="max-width: 80%; height: auto;">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
