...
<head>
    <meta charset="utf-8">
    <title>All Breakfast Items - The Golden Grain</title>
            ...
            <div id="content" class="flex-fill d-flex flex-column">
                <div class="container-fluid py-4 flex-fill d-flex flex-column">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 flex-wrap">
                        <h1 class="h3 mb-0 text-gray-800">All Breakfast Items</h1>
                        <a href="add_breakfast_item.php" class="btn btn-primary btn-sm shadow-sm">
                    ...
                    <div class="row">
                        <?php
                        $result = $conn->query("
                            SELECT b.*, m.menu_category 
                            FROM breakfast_items b 
                            LEFT JOIN menu_category m ON b.menu_category_id = m.menu_category_id 
                        ...
                        ?>
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 d-flex">
                                    <div class="card flex-fill shadow-sm">
                                        <img src="uploads/breakfast_items/<?= htmlspecialchars($row['photo']) ?>" class="card-img-top" style="object-fit: cover; height:200px;">
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="mt-auto d-flex justify-content-between">
                                                <a href="edit_breakfast_item.php?id=<?= $row['item_id'] ?>" class="btn btn-sm btn-primary">Edit</a>
                                                <a href="delete_breakfast_item.php?id=<?= $row['item_id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        <?php
                            ...
                            echo "<div class='col-12 text-center'><p>No breakfast items added yet.</p></div>";
                        }
                        ?>
                    </div>
