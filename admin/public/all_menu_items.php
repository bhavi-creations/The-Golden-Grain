...
<head>
    <meta charset="utf-8">
    <title>Menu Items - The Golden Grain</title>
            ...
            <div id="content" class="flex-fill d-flex flex-column">
                <div class="container-fluid py-4 flex-fill d-flex flex-column">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 flex-wrap">
                        ...
                        <a href="add_menu_item.php" class="btn btn-primary btn-sm shadow-sm">
                    ...
                    <div class="row">
                        ...
                        ?>
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 d-flex">
                                    <div class="card flex-fill shadow-sm">
                                        <img src="uploads/menu_items/<?= htmlspecialchars($row['photo']) ?>" class="card-img-top" style="object-fit: cover; height:200px;">
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="mt-auto d-flex justify-content-between">
                                                <a href="edit_menu_item.php?id=<?= $row['item_id'] ?>" class="btn btn-sm btn-primary">Edit</a>
                                                <a href="delete_menu_item.php?id=<?= $row['item_id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        <?php
                            ...
                            echo "<div class='col-12 text-center'><p>No menu items added yet.</p></div>";
                        }
                        ?>
                    </div>
