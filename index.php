     ...
     <div class="slider-container">
     	...
     	<div id="mainSlider" class="nivoSlider slider-image">
     		<img src="images/slider/1.webp" alt="" title="#htmlcaption1" />
     		<img src="images/slider/3.webp" alt="" title="#htmlcaption2" />
     		<img src="images/slider/2.webp" alt="" title="#htmlcaption3" />
     	</div>
     	<!-- Slider Caption 1 -->
     						...
     						<div class="col-lg-2 col-md-3 d-lg-block d-md-block d-none">
     							<div class="social-media-follow">
     								<div class="social-box-inner">
     									<ul>
     										<li><a ><i class="mdi mdi-facebook"></i></a></li>
     										<li><a ><i class="mdi mdi-twitter"></i></a></li>
     										<li><a ><i class="mdi mdi-dribbble"></i></a></li>
     										<li><a ><i class="mdi mdi-pinterest"></i></a></li>
     										<li><a ><i class="mdi mdi-instagram"></i></a></li>
     									</ul>
     								</div>
     								<p>follow on</p>
     							</div>
     							...
     							<div class="slide1-text">
     								<div class="middle-text">
     									<div class="title-1 wow rotateInDownRight" data-wow-duration="0.9s" data-wow-delay="0s">
     										<h2>Welcome Resta Restaurant</h2>
     									</div>
     									...
     									<div class="desc wow slideInRight" data-wow-duration="1.2s" data-wow-delay="0.2s">
     										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque vel volutpat felis, <br> eu condimentum. lorem ipsum dolor. lorem ipsum dolor sit amt.</p>
     									</div>
     								...
     								<div class="dises-show text-center">
     									<div class="row">
     										<div class="col-lg-4 col-md-6">
     											<div class="single-disesh">
     												<div class="disesh-img">
     													<a ><img src="images/dish/1.png" alt=""></a>
     												</div>
     												<div class="disesh-desc pt-50">
     													<h3><a >Dish Name Here</a></h3>
     													<p class="price">₹100</p>
     												</div>
     											</div>
     										</div>
     										<div class="col-lg-4 col-md-6">
     											<div class="single-disesh">
     												<div class="disesh-img">
     													<a ><img src="images/dish/2.png" alt=""></a>
     												</div>
     												<div class="disesh-desc pt-50">
     													<h3><a >Dish Name Here</a></h3>
     													<p class="price">₹100</p>
     										...
     										<div class="col-lg-4 d-lg-block d-md-none d-block">
     											<div class="single-disesh">
     												<div class="disesh-img">
     													<a ><img src="images/dish/3.png" alt=""></a>
     												</div>
     												<div class="disesh-desc pt-50">
     													<h3><a >Dish Name Here</a></h3>
     													<p class="price">₹100</p>
     			...
     			<div class="row">
     				<div class="col-lg-12">
     					...
     					<div class="gallery-item-box row">
     						...
     						<div class="col-lg-4 col-md-6 gallery-item coffee catering mb-30">
     							<div class="single-item-gallery">
     						...
     						<div class="col-lg-4 col-md-6 gallery-item coffee drink catering mb-30">
     							<div class="single-item-gallery">
     						...
     						<div class="col-lg-4 col-md-6 gallery-item desert catering mb-30">
     							<div class="single-item-gallery">
     				...
     				<div class="col-lg-12">
     					<div class="reserv-section-inner">
     						...
     						<div class="reserve-form">
     							<h3 class="reserv-title mb-60">Book Your Table</h3>
     							<form action="#">
     	...
     	<div class="container">
     		...
     		<div class="blog-details">
     			<div class="row">
     					...
     					<div class="single-blog">
     						...
     						<div class="blog-desc">
     							...
     							<div class="blog-title">
     								<h3><a >Lorem Ipsum is simply dummy</a></h3>
     							</div>
     						</div>
     					</div>
     				</div>
     				...
     				<div class="col-lg-4 col-md-6 d-lg-block d-md-none d-block">
     					<div class="single-blog">
     						<div class="blog-thumbnail">
